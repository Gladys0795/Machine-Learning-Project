...
- Food_item	(Name of the food product)
- Category (Food category)
- Storage_temperature_C	(Recommended storage temperature (°C))
- Max_fridge_days	(Maximum recommended refrigeration period)
- Max_freezer_months	(Maximum recommended freezer storage period)
- Spoilage_visual_signs	(Visible indicators of spoilage)
- Spoilage_odor_signs	(Odour-related spoilage indicators)
- Risk	(Food spoilage risk level (Target Variable))
- Guideline	(Food safety guideline source)
...
- A cleaned and preprocessed food spoilage dataset
- Exploratory data analysis with visualisations
- A predictive machine learning model
- Identification of key factors influencing food spoilage
- Recommendations for safer food storage practices
